                            ...
                            <div className="flex md:flex-row flex-col gap-y-2 md:gap-x-4 text-white">
                                ...
                                <div className="flex flex-col">
                                    <div className="flex justify-end">
                                        <TimerWindow ref={flipped ? whitePlayerTimerRef : blackPlayerTimerRef} time={300} color={flipped ? WHITE : BLACK} onTimerUp={() => handleTimeOut(flipped ? BLACK : WHITE)}></TimerWindow>
                                    </div>
                                    <Board onePlayer={onePlayer} />
                                    <div className="flex justify-end">
                                        <TimerWindow ref={flipped ? blackPlayerTimerRef : whitePlayerTimerRef} time={300} color={flipped ? BLACK : WHITE} onTimerUp={() => handleTimeOut(flipped ? WHITE : BLACK)}></TimerWindow>
                                    </div>
                                </div>
                            </div>
                        </div>
